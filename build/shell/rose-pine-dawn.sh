...
do_osc() {
    ...
    print_osc4 9 "bd/76/8a"
    print_osc4 10 "2c/74/90"
    print_osc4 11 "ed/aa/4e"
    print_osc4 12 "63/a0/ab"
    print_osc4 13 "9f/8c/b4"
    print_osc4 14 "df/9b/98"
    print_osc4 15 "57/52/79"

    print_osc_rgb 10 "57/52/79"
    print_osc_rgb 11 "fa/f4/ed"
    print_osc_rgb 12 "ce/ca/cd"
...
do_linux() {
    ...
    print_linux 9 "#bd768a"
    print_linux 10 "#2c7490"
    print_linux 11 "#edaa4e"
    print_linux 12 "#63a0ab"
    print_linux 13 "#9f8cb4"
    print_linux 14 "#df9b98"
