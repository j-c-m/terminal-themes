...
do_osc() {
    ...
    print_osc4 3 "d2/7b/53"
    print_osc4 4 "66/99/cc"
    print_osc4 5 "cc/99/cc"
    print_osc4 6 "66/cc/cc"
    print_osc4 7 "d3/d0/c8"
    print_osc4 8 "74/73/69"
    ...
    print_osc_rgb 10 "d3/d0/c8"
    print_osc_rgb 11 "2d/2d/2d"
    print_osc_rgb 12 "d3/d0/c8"
    print_osc_rgb 17 "d3/d0/c8"
...
do_linux() {
    ...
    print_linux 3 "#d27b53"
    print_linux 4 "#6699cc"
    print_linux 5 "#cc99cc"
    print_linux 6 "#66cccc"
    print_linux 7 "#d3d0c8"
    print_linux 8 "#747369"
